...
Definition record_gotos (f: LTL_old.function) : U.t :=
...
Definition tunnel_function (f: LTL_old.function) : LTL_old.function :=
...
Definition tunnel_fundef (f: LTL_old.fundef) : LTL_old.fundef :=
  transf_fundef tunnel_function f.

Definition tunnel_program (p: LTL_old.program) : LTL_old.program :=
