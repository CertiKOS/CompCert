...
Require Archi.
Require Import AST_old Values_old Memory_old Globalenvs_old Events_old.
Require Import Cminor_old Op_old CminorSel_old.
Require Import SelectOp_old SelectOpproof_old SplitLong_old SplitLongproof_old.
Require Import SelectLong_old.
...
Proof.
  ...
  apply SplitLongproof_old.eval_longconst.
  EvalOp.
Qed.
...
Proof with (try discriminate).
  ...
  eapply SplitLongproof_old.is_longconst_sound; eauto.
...
Proof.
  unfold intoflong; destruct Archi.splitlong. apply SplitLongproof_old.eval_intoflong.
...
Proof.
  unfold longofintu; destruct Archi.splitlong. apply SplitLongproof_old.eval_longofintu.
...
Proof.
  unfold longofint; destruct Archi.splitlong. apply SplitLongproof_old.eval_longofint.
  red; intros. destruct (is_intconst a) as [n|] eqn:C.
- econstructor; split. apply eval_longconst.
  exploit is_intconst_sound; eauto. intros; subst x. auto.
- TrivialExists.
...
Proof.
  unfold notl; destruct Archi.splitlong. apply SplitLongproof_old.eval_notl.
...
Proof.
  unfold andl; destruct Archi.splitlong. apply SplitLongproof_old.eval_andl.
...
Proof.
  unfold orl; destruct Archi.splitlong. apply SplitLongproof_old.eval_orl.
  red; intros.
...
Proof.
  unfold xorl; destruct Archi.splitlong. apply SplitLongproof_old.eval_xorl.
...
Proof.
  intros; unfold shllimm. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shllimm; auto.
  red; intros.
...
Proof.
  intros; unfold shrluimm. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shrluimm; auto.
  red; intros.
  predSpec Int.eq Int.eq_spec n Int.zero.
  exists x; split; auto. subst n; destruct x; simpl; auto.
  destruct (Int.ltu Int.zero Int64.iwordsize'); auto.
...
Proof.
  intros; unfold shrlimm. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shrlimm; auto.
  red; intros.
  predSpec Int.eq Int.eq_spec n Int.zero.
  exists x; split; auto. subst n; destruct x; simpl; auto.
  destruct (Int.ltu Int.zero Int64.iwordsize'); auto.
...
Proof.
  unfold shll. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shll; auto.
...
Proof.
  unfold shrlu. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shrlu; auto.
  red; intros. destruct (is_intconst b) as [n2|] eqn:C.
...
Proof.
  unfold shrl. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_shrl; auto.
  red; intros. destruct (is_intconst b) as [n2|] eqn:C.
...
Proof.
  unfold negl. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_negl; auto.
  red; intros. destruct (is_longconst a) as [n|] eqn:C.
...
Proof.
  ...
  apply SplitLongproof_old.eval_addl. eauto. apply Archi.splitlong_ptr32; auto.
...
Proof.
  ...
  apply SplitLongproof_old.eval_subl. eauto. apply Archi.splitlong_ptr32; auto.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_mullimm; eauto.  
  predSpec Int64.eq Int64.eq_spec n Int64.zero.
  exists (Vlong Int64.zero); split. apply eval_longconst.
...
Proof.
  unfold mull. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_mull; auto.
...
Proof.
  unfold mullhu; intros. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_mullhu; auto.
...
Proof.
  unfold mullhs; intros. destruct Archi.splitlong eqn:SL. apply SplitLongproof_old.eval_mullhs; auto.
  red; intros. TrivialExists. constructor. eauto. constructor. apply eval_longconst. constructor. auto.
Qed.
...
+ eapply SplitLongproof_old.eval_shrxlimm; eauto using Archi.splitlong_ptr32.
+ predSpec Int.eq Int.eq_spec n Int.zero.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_divls_base; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_modls_base; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_divlu_base; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_modlu_base; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_cmplu; eauto using Archi.splitlong_ptr32.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_cmpl; eauto.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_longoffloat; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_floatoflong; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_longofsingle; eauto.
  TrivialExists.
Qed.
...
Proof.
  ...
  eapply SplitLongproof_old.eval_singleoflong; eauto.
  TrivialExists.
Qed.
