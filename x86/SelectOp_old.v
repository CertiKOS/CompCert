...
Inductive builtin_arg_cases: forall (e: expr), Type :=
  ...
  | builtin_arg_case3: forall id ofs, builtin_arg_cases (Eop (Olea (Aglobal id ofs)) Enil)
  | builtin_arg_case4: forall ofs, builtin_arg_cases (Eop (Olea (Ainstack ofs)) Enil)
  | builtin_arg_case5: forall id ofs, builtin_arg_cases (Eop (Oleal (Aglobal id ofs)) Enil)
  | builtin_arg_case6: forall ofs, builtin_arg_cases (Eop (Oleal (Ainstack ofs)) Enil)
  | builtin_arg_case7: forall h l, builtin_arg_cases (Eop Omakelong (Eop (Ointconst h) Enil ::: Eop (Ointconst l) Enil ::: Enil))
  | builtin_arg_case8: forall h l, builtin_arg_cases (Eop Omakelong (h ::: l ::: Enil))
  | builtin_arg_case9: forall chunk id ofs, builtin_arg_cases (Eload chunk (Aglobal id ofs) Enil)
  | builtin_arg_case10: forall chunk ofs, builtin_arg_cases (Eload chunk (Ainstack ofs) Enil)
...
Definition builtin_arg_match (e: expr) :=
  ...
  | Eop (Olea (Aglobal id ofs)) Enil => builtin_arg_case3 id ofs
  | Eop (Olea (Ainstack ofs)) Enil => builtin_arg_case4 ofs
  | Eop (Oleal (Aglobal id ofs)) Enil => builtin_arg_case5 id ofs
  | Eop (Oleal (Ainstack ofs)) Enil => builtin_arg_case6 ofs
  | Eop Omakelong (Eop (Ointconst h) Enil ::: Eop (Ointconst l) Enil ::: Enil) => builtin_arg_case7 h l
  | Eop Omakelong (h ::: l ::: Enil) => builtin_arg_case8 h l
  | Eload chunk (Aglobal id ofs) Enil => builtin_arg_case9 chunk id ofs
  | Eload chunk (Ainstack ofs) Enil => builtin_arg_case10 chunk ofs
...
Definition builtin_arg (e: expr) :=
  ...
  | builtin_arg_case2 n => (* Eop (Olongconst n) Enil *) 
      BA_long n
  | builtin_arg_case3 id ofs => (* Eop (Olea (Aglobal id ofs)) Enil *) 
      if Archi.ptr64 then BA e else BA_addrglobal id ofs
  | builtin_arg_case4 ofs => (* Eop (Olea (Ainstack ofs)) Enil *) 
      if Archi.ptr64 then BA e else BA_addrstack ofs
  | builtin_arg_case5 id ofs => (* Eop (Oleal (Aglobal id ofs)) Enil *) 
      if Archi.ptr64 then BA_addrglobal id ofs else BA e
  | builtin_arg_case6 ofs => (* Eop (Oleal (Ainstack ofs)) Enil *) 
      if Archi.ptr64 then BA_addrstack ofs else BA e
  | builtin_arg_case7 h l => (* Eop Omakelong (Eop (Ointconst h) Enil ::: Eop (Ointconst l) Enil ::: Enil) *) 
      BA_long (Int64.ofwords h l)
  | builtin_arg_case8 h l => (* Eop Omakelong (h ::: l ::: Enil) *) 
      BA_splitlong (BA h) (BA l)
  | builtin_arg_case9 chunk id ofs => (* Eload chunk (Aglobal id ofs) Enil *) 
      BA_loadglobal chunk id ofs
  | builtin_arg_case10 chunk ofs => (* Eload chunk (Ainstack ofs) Enil *) 
