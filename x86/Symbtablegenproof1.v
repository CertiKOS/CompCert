...
Lemma get_var_entry_size : forall rdid did cid rdsz dsz csz id v, 
    symbentry_size (get_symbentry rdid did cid rdsz dsz csz id (Some (Gvar v))) = AST.init_data_list_size (gvar_init v).
Proof.
  intros.
...
Proof.
  ...
  unfold update_section_size. destruct def. destruct g. destruct f.
...
Lemma get_var_entry_type : forall rodid did cid rdsz1 dsz1 csz1 id v,
    symbentry_type (get_symbentry rodid did cid rdsz1 dsz1 csz1 id (Some (Gvar v))) = symb_data.
Proof.
  intros. cbn.
...
Lemma get_fun_entry_type : forall rodid did cid rdsz1 dsz1 csz1 id f,
    symbentry_type (get_symbentry rodid did cid rdsz1 dsz1 csz1 id (Some (Gfun f))) = symb_func.
Proof.
  intros. cbn.
  destruct f; auto.
Qed.
...
Lemma get_symbentry_eq_gvar_init_readonly: forall rodid did cid rdsz1 dsz1 csz1 id v1 v2,
    ...
    get_symbentry rodid did cid rdsz1 dsz1 csz1 id (Some (Gvar v1)) = 
    get_symbentry rodid did cid rdsz1 dsz1 csz1 id (Some (Gvar v2)).
Proof.
...
Definition def_rodata_size (def: option gdef) :=
...
Definition defs_rodata_size (defs: list (option gdef)) :=
...
Lemma acc_symb_tree_entry_some_inv:
  forall (rdid did cid : N) (defs : list (ident * option (globdef fundef unit)))
...
Lemma acc_symb_size':
  forall (rd_id r_id c_id : N) (defs : list (ident * option (globdef fundef unit)))
