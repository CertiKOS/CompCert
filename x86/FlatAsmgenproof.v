...
Lemma transl_instrs_gen_valid_code_labels : forall instrs (gmap: GID_MAP_TYPE) i tp sid ofs1 ofs2 ofs' instrs',
...
Lemma transl_fun_gen_valid_code_labels : forall gmap i f f' tp,
  (forall id b, gmap id = Some b -> In (fst b) (map segid (list_of_segments tp))) ->
...
Lemma transl_globdefs_gen_valid_code_labels : forall defs gmap tdefs code tp,
  (forall id b, gmap id = Some b -> In (fst b) (map segid (list_of_segments tp))) ->
  transl_globdefs gmap defs = OK (tdefs, code) ->
