...
Lemma collect_internal_def_ids_inv: forall {F V} (p: program (fundef F) V) id,
    ...
    exists def, (prog_defmap p)!id = Some def /\ 
...
Lemma link_prog_merge_some1: 
  forall {F V} {LF: Linker F} {LV: Linker V} a (def: globdef F V) (p1 p2: program F V),
    prog_linkable p1 p2 ->
    (prog_defmap p1)!a = Some def ->
...
Lemma link_prog_merge_pres_get1: forall {F V} {LF: Linker F} {LV: Linker V} a (def: globdef F V) (p1 p2: program F V),
    prog_linkable p1 p2 ->
    (prog_defmap p1) ! a = Some def ->
    exists def', 
      (PTree.combine link_prog_merge (prog_defmap p1)
                     (prog_defmap p2)) ! a = Some def'.
Proof.
...
Lemma link_prog_merge_pres_get2: forall {F V} {LF: Linker F} {LV: Linker V} a (def: globdef F V) (p1 p2: program F V),
    prog_linkable p1 p2 ->
    (prog_defmap p2) ! a = Some def ->
    exists def', 
      (PTree.combine link_prog_merge (prog_defmap p1)
