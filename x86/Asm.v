...
Definition instr_to_string (i:instruction) : string :=
  ...
  | Pnop => "Pnop"
  (* (** Instructions not generated by [Asmgen] -- TO CHECK *) *)
  | Padcl_ri _ _ => "Padcl_ri"
  | Padcl_rr _ _ => "Padcl_rr" 
  | Paddl_mi _ _ => "Paddl_mi"
  | Paddl_rr _ _ => "Paddl_rr"
  | Pbsfl _ _ => "Pbsfl"
  | Pbsfq _ _ => "Pbsfq"
  | Pbsrl _ _ => "Pbsrl"
  | Pbsrq _ _ => "Pbsrq"
  ...
  | Pbswap32 _ => "Pbswap32"
  | Pbswap16 _ => "Pbswap16"
  | Pcfi_adjust _ => "Pcfi_adjust"
  | Pfmadd132 _ _ _ => "Pfmadd132"
  | Pfmadd213 _ _ _ => "Pfmadd213"
  | Pfmadd231 _ _ _ => "Pfmadd231"
  | Pfmsub132 _ _ _ => "Pfmsub132"
  | Pfmsub213 _ _ _ => "Pfmsub213"
  | Pfmsub231 _ _ _ => "Pfmsub231"
  | Pfnmadd132 _ _ _ => "Pfnmadd132"
  | Pfnmadd213 _ _ _ => "Pfnmadd213"
  | Pfnmadd231 _ _ _ => "Pfnmadd231"
  | Pfnmsub132 _ _ _ => "Pfnmsub132"
  | Pfnmsub213 _ _ _ => "Pfnmsub213"
  | Pfnmsub231 _ _ _ => "Pfnmsub231"
  | Pmaxsd _ _ => "Pmaxsd"
  | Pminsd _ _ => "Pminsd"
  | Pmovb_rm _ _  => "Pmovb_rm"
  | Pmovsq_mr _ _ => "Pmovsq_mr"
  | Pmovsq_rm _ _ => "Pmovsq_rm"
  | Pmovsb => "Pmovsb"
  | Pmovsw => "Pmovsw"
  | Pmovw_rm _ _ => "Pmovw_rm"
  | Prep_movsl => "Prep_movsl"
  | Psbbl_rr _ _ => "Psbbl_rr"
  | Psqrtsd _ _ => "Psqrtsd"
  | Psubl_ri _ _ => "Psubl_ri"
  | Psubq_ri _ _ => "Psubq_ri"
  end.

Definition extfun_str (ef:external_function) : string :=
  match ef with
  | EF_external s _ => "EF_external " ++ s
  | EF_builtin s _ => "EF_builtin " ++ s
  | EF_runtime s _ => "EF_runtime " ++ s
  | EF_vload _ => "EF_vload"
  | EF_vstore _ => "EF_vstore"
  | EF_malloc => "EF_malloc"
  | EF_memcpy _ _ => "EF_memcpy"
  | EF_annot s _ => "EF_annot " ++ s
  | EF_annot_val s _ => "EF_annot_val " ++ s
  | EF_inline_asm s _ _ => "EF_inline_asm " ++ s
  | EF_debug _ _ _ => "EF_debug"
  end.
