...
Inductive instruction: Type :=
  ...
  (*SACC:*)| Pxchg_rr (r1: ireg) (r2: ireg)      (**r register-register exchange *)
  ...
  (** Branches and calls *)
  | Pjmp_l (l: label)
  (*SACC:*)| Pjmp (ros: ireg + ident) (sg: signature)
  (*SACC: comments this*)(*
  ...
  (*SACC:*)| Pcall (ros: ireg + ident) (sg: signature)
  (*SACC: comments this*)(*
  ...
  (*SACC:*)| Pload_parent_pointer (rd: ireg) (sz:Z)
  | Pbuiltin(ef: external_function)(args: list (builtin_arg preg))(res: builtin_res preg)
  (**SACC: Local jumps using relative offsets *)
  (*SACC:*)| Pjmp_l_rel (ofs: Z)
  (*SACC:*)| Pjcc_rel (c: testcond)(ofs: Z)
  (*SACC:*)| Pjcc2_rel (c1 c2: testcond)(ofs: Z)   (**r pseudo *)
  (*SACC:*)| Pjmptbl_rel (r: ireg) (tbl: list Z) (**r pseudo *)
  (**SACC: Nop *)
  (*SACC:*)| Pnop
