...
Definition const_for_result (a: aval) : option operation :=
  ...
  | F n => if Compopts_old.generate_float_constants tt then Some(Ofloatconst n) else None
  | FS n => if Compopts_old.generate_float_constants tt then Some(Osingleconst n) else None
  | Ptr(Gl id ofs) =>
