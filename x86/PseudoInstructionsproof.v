...
Section WITHMEMORYMODEL.
  ...
  Proof.
    ...
    rewrite NEXT. destruct (peq b (Genv.genv_next t0)). inv H3. congruence. auto.
    inv H. inv H2. auto.
    rewrite ! Maps.PTree.gsspec.
    rewrite NEXT. destruct (peq b (Genv.genv_next t0)). inv H3. congruence. auto.
    auto.
  ...
  Proof.
    ...
    - exploit functions_transl. eauto. intros FFP.
      ...
      + subst; simpl in *. inv H2. inv CA. inv H7. inv H9.
        ...
        erewrite (instr_size_alloc sz ofs_ra (align sz 8 - size_chunk Mptr)
                                   (size_chunk Mptr)).
        ...
        * subst. simpl_regs. rewrite H. simpl. f_equal.
          ...
          generalize (instr_size_positive (Pallocframe sz ofs_ra)); omega.
          setoid_rewrite <- (instr_size_alloc sz ofs_ra).
          generalize (instr_size_positive (Pallocframe sz ofs_ra)); omega.
