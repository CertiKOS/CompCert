...
Require Import Ctypes_old Cop_old Clight_old.
Require Compopts_old.
...
Definition transf_program (p: program) : res program :=
  do p1 <- AST_old.transform_partial_program transf_fundef p;
