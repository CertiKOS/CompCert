...
Parameter do_external_function:
  ...
  Determinism.world -> list Values.val -> Memory.mem ->
  option (Determinism.world * Events.trace * Values.val * Memory.mem).
...
Check Events.external_functions_sem.
...
Lemma do_external_function_sound:
   forall (id : String.string) (sg : AST.signature) 
     ...
     (m : Memory.mem) (t : Events.trace) (vres : Values.val)
     (m' : Memory.mem) (w w' : Determinism.world),
...
Definition do_step ge := Cexec.do_step ge do_external_function do_inline_assembly.
Definition do_initial_state := Cexec.do_initial_state.
Definition at_final_state := Cexec.at_final_state.
Definition step_expr ge := Cexec.step_expr ge do_external_function do_inline_assembly.
...
Proof.
  apply Cexec.do_step_sound; intros.
  Check do_external_function_sound.
  apply (do_external_function_sound _ _ _ _ _ _ _ _ _ _ H).
  eauto using
