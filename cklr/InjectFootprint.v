...
Hint Constructors injp_match_mem injp_match_stbls: injp.
...
Next Obligation. (* Mem.alloc *)
  ...
  exists (injpw f' m1' m2' Hm'); split; repeat rstep; eauto with injp.
  constructor.
  ...
  - red. intros b b' delta Hb Hb'.
    ...
    subst.
    split; eauto using Mem.fresh_block_alloc with injp.
Qed.
